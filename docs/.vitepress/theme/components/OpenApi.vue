      ...
      <div class="card-header">
        ...
        <div class="api-meta">
          ...
          <div class="meta-item">
            ...
            <span>速率限制: {{ apiData.rate_limit }} 次/秒</span>
          </div>
          <div class="meta-item">
...
th:nth-child(4),
td:nth-child(4) {
  min-width: 160px; /* 描述最小宽度 */
}

th:nth-child(5),
td:nth-child(5) {
  min-width: 220px; /* 描述最小宽度 */
}
